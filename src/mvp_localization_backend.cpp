...
MvpLocalizationBackend::MvpLocalizationBackend() : Node("mvp_localization_node"), initialized_(false), count_(0) {
    // 1. Define IMU Parameters
    auto p = PreintegratedCombinedMeasurements::Params::MakeSharedD(9.81);
    Matrix33 I_3x3 = Matrix33::Identity();
    ...
    imu_sub_ = this->create_subscription<sensor_msgs::msg::Imu>(
        "imu/data", 10, std::bind(&MvpLocalizationBackend::imuCallback, this, std::placeholders::_1));
    
    gps_sub_ = this->create_subscription<sensor_msgs::msg::NavSatFix>(
        "gps/fix", 10, std::bind(&MvpLocalizationBackend::gpsCallback, this, std::placeholders::_1));

    dvl_sub_ = this->create_subscription<geometry_msgs::msg::TwistStamped>(
         "dvl/twist", 10, std::bind(&MvpLocalizationBackend::dvlCallback, this, std::placeholders::_1));

    depth_sub_ = this->create_subscription<nav_msgs::msg::Odometry>(
         "depth/odometry", 10, std::bind(&MvpLocalizationBackend::depthCallback, this, std::placeholders::_1));
    
    odom_pub_ = this->create_publisher<nav_msgs::msg::Odometry>("gtsam/odometry", 10);
    ...
    timer_ = this->create_wall_timer(
        ...
        std::bind(&MvpLocalizationBackend::publishOdomCallback, this));

    RCLCPP_INFO(this->get_logger(), "GTSAM Node initialized.");
}


void MvpLocalizationBackend::initializeSystem(const sensor_msgs::msg::NavSatFix::SharedPtr msg) {
...
void MvpLocalizationBackend::imuCallback(const sensor_msgs::msg::Imu::SharedPtr msg) {
...
void MvpLocalizationBackend::dvlCallback(const geometry_msgs::msg::TwistStamped::SharedPtr msg) {
   
}

void MvpLocalizationBackend::depthCallback(const nav_msgs::msg::Odometry::SharedPtr msg) {
   
}


void MvpLocalizationBackend::gpsCallback(const sensor_msgs::msg::NavSatFix::SharedPtr msg) {
    if (!initialized_) {
...
void MvpLocalizationBackend::publishOdomCallback() {
    ...
    NavState state;
    {
        ...
        state = pim_->predict(prev_state_, prev_bias_);
    }
...
void MvpLocalizationBackend::f_ll2dis(geographic_msgs::msg::GeoPoint ll_point, geometry_msgs::msg::Point::SharedPtr map_point)
{
...
void MvpLocalizationBackend::f_dis2ll(geometry_msgs::msg::Point map_point, geographic_msgs::msg::GeoPoint::SharedPtr ll_point)
{
    //from world frame
